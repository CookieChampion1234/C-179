...
fruit_image = Label(root, bg="orange1")
...
fruit_dropdown = ttk.Combobox(root, state="readoly", values=fruit_list, justify="right")
fruit_dropdown.place(relx=0.95, rely=0.25, anchor=E)

label_quantity = Label(root, text="Enter Quality", bg="orange2", font=("Bahnschrift Light", 15))
